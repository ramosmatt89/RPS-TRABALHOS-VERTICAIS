            ...
            <motion.div style={{ opacity }}>
              ...
              >
                <div>
                  ...
                  <div className="text-[10px] text-gray-500 uppercase tracking-widest font-bold">Segurança</div>
                </div>
                <div className="h-10 w-[1px] bg-white/10"></div>
                <div>
                  <div className="text-2xl lg:text-3xl font-black">+2k</div>
                  <div className="text-[10px] text-gray-500 uppercase tracking-widest font-bold">Projetos</div>
                </div>
                <div className="h-10 w-[1px] bg-white/10"></div>
                <div>
                  <div className="text-2xl lg:text-3xl font-black">24h</div>
                  <div className="text-[10px] text-gray-500 uppercase tracking-widest font-bold">Resposta</div>
                </div>
              </motion.div>
            </motion.div>
          </div>
