...
export const SERVICES: EnhancedService[] = [
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1595844730298-b960ff98fee0?q=80&w=1200&auto=format&fit=crop'
  },
  {
    id: '3',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1635834166244-10660f607412?q=80&w=1200&auto=format&fit=crop'
  },
  {
    id: '6',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1541888941295-1e87ab2d488d?q=80&w=1200&auto=format&fit=crop'
  },
  {
    id: '8',
...
export const PORTFOLIO: PortfolioItem[] = [
  { id: '1', title: 'Limpeza de Vidros e Fachadas', category: 'Lavagem Alta Pressão', image: 'https://images.unsplash.com/photo-1521791136064-7986c2920216?q=80&w=1200&auto=format&fit=crop' },
  { id: '2', title: 'Pintura de Prédio Residencial', category: 'Pintura Especializada', image: 'https://images.unsplash.com/photo-1562259949-e8e7689d7828?q=80&w=1200&auto=format&fit=crop' },
  { id: '3', title: 'Impermeabilização de Coberturas', category: 'Impermeabilizações', image: 'https://images.unsplash.com/photo-1635834166244-10660f607412?q=80&w=1200&auto=format&fit=crop' },
  { id: '4', title: 'Manutenção de Caleiras em Prédio', category: 'Caleiras e Algeroz', image: 'https://images.unsplash.com/photo-1632759145351-1d592919f522?q=80&w=1200&auto=format&fit=crop' },
  { id: '5', title: 'Reparação de Juntas de Dilatação', category: 'Juntas Estruturais', image: 'https://images.unsplash.com/photo-1541888941295-1e87ab2d488d?q=80&w=1200&auto=format&fit=crop' },
  { id: '6', title: 'Isolamento Térmico Exterior', category: 'Isolamentos', image: 'https://images.unsplash.com/photo-1504307651254-35680f356dfd?q=80&w=1200&auto=format&fit=crop' }
];
